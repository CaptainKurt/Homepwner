...
+ (instancetype)randomItem
{
    ...
    NSArray *randomNounList = @[@"Bear", @"Alien", @"Mac"];
    
    // Get the index of a random adjective/noun from the lists
    // Note: The % operator, called the modulo operator, gives you
    // the remainder. So adjectiveIndex is a random number from 0 to 2 inclusive.
...
- (void)setThumbnailFromImage:(UIImage *)image
{
    ...
    // Figure out a scaling ratio to make sure we maintain the same aspect ration
